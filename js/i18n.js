...
const TRANSLATIONS = {
    en: {
        ...
        'lookup.freeBadge': 'OSINT · free',
        'lookup.loginBadge': 'eID / itsme',
        'lookup.open': 'Open',
        ...
        'lookup.group.living': 'Neighbourhood & daily life',
        'lookup.group.prices': 'Prices & market',
        'lookup.finding.ph': 'Noted finding, e.g. P-score C',
        'lookup.findingLabel': 'Your finding (appears in the report)',
        'menu.btn': 'Menu',
        'menu.visit': 'During the visit',
        'menu.data': 'Your data',
        'menu.info': 'Lookups & information',
        'menu.display': 'Display',
        'prop.lookupLink': 'Official lookups for this address',
        'report.research': 'Address research (official lookups)',
        'group.view': 'Display & language',
        'rail.label': 'Quick actions',
        'howto.title': 'How it works',
        'howto.step1': 'Fill in the address once - the region, legal deadlines and official lookups adapt automatically.',
        'howto.step2': 'Walk through the house with the checklist: tick OK or Issue, add notes and photos per point.',
        'howto.step3': 'Turn the result into a report, PDF, share link or negotiation summary - everything stays on your device.',
        'howto.dismiss': 'Hide this explanation',
        'photo.add': 'Add photo',
        'photo.title': 'Photos',
        'photo.view': 'View photo',
        'photo.delete': 'Delete photo',
        'photo.deleted': 'Photo deleted.',
        'photo.error': 'Could not save the photo.',
        'photo.limit': 'Maximum 6 photos per item.',
        'photo.hint': 'Photos stay on this device: they are included when you print or export a PDF here, but never in share links or JSON backups.',
        'photo.annotate': 'Annotate',
        'photo.pen': 'Pen',
        'photo.arrow': 'Arrow',
        'photo.circle': 'Circle',
        'photo.undo': 'Undo last stroke',
        'photo.annoSave': 'Save annotation',
        'photo.annoCancel': 'Cancel',
        'photo.annoSaved': 'Annotation saved into the photo.',
        'btn.visit': 'Room by room',
        'visit.title': 'Room-by-room visit',
        'visit.intro': 'Walk through the property one room at a time. Pick the room you are standing in, tick what is present, and the matching checks appear.',
        'visit.room': 'Which room are you in?',
        'visit.features': 'What is in this room?',
        'visit.hint': 'Everything you tick, note, photograph or annotate here lands in the same inspection as the main checklist - nothing to copy over.',
        'visit.empty': 'Pick a room above to see its checks.',
        'visit.answered': '{done} of {total} points answered in this selection',
        'visit.another': 'Add another: {room}',
        'visit.instanceHint': 'Extra rooms are a walking aid stored on this device: the main checklist keeps one shared answer per point - an issue found in any room wins.',
        'visit.missing': 'You did not select “{feature}”. Is there none in this room?',
        'visit.missingConfirm': 'Correct - there is none',
        'visit.missingAdd': 'There is - show those checks',
        'visit.absenceNoted': 'Noted: no “{feature}” in {room}.',
        'visit.absenceLine': '{room}: no “{feature}” present.',
        'visit.absenceUndo': 'Remove this note',
    ...
    nl: {
        ...
        'lookup.group.living': 'Buurt & dagelijks leven',
        'lookup.group.prices': 'Prijzen & markt',
        'lookup.finding.ph': 'Genoteerde vaststelling, bv. P-score C',
        'lookup.findingLabel': 'Uw vaststelling (komt in het rapport)',
        'menu.btn': 'Menu',
        'menu.visit': 'Tijdens het bezoek',
        'menu.data': 'Uw gegevens',
        'menu.info': 'Opzoekingen & informatie',
        'menu.display': 'Weergave',
        'prop.lookupLink': 'Officiële opzoekingen voor dit adres',
        'report.research': 'Adresonderzoek (officiële opzoekingen)',
        'group.view': 'Weergave & taal',
        'rail.label': 'Snelle acties',
        'howto.title': 'Zo werkt het',
        'howto.step1': 'Vul één keer het adres in - de regio, wettelijke termijnen en officiële opzoekingen passen zich automatisch aan.',
        'howto.step2': 'Loop door de woning met de checklist: vink OK of Probleem aan, voeg per punt notities en foto\'s toe.',
        'howto.step3': 'Zet het resultaat om in een rapport, pdf, deellink of onderhandelingsoverzicht - alles blijft op uw toestel.',
        'howto.dismiss': 'Verberg deze uitleg',
        'photo.add': 'Foto toevoegen',
        'photo.title': 'Foto\'s',
        'photo.view': 'Foto bekijken',
        'photo.delete': 'Foto verwijderen',
        'photo.deleted': 'Foto verwijderd.',
        'photo.error': 'Kon de foto niet opslaan.',
        'photo.limit': 'Maximaal 6 foto\'s per punt.',
        'photo.hint': 'Foto\'s blijven op dit toestel: ze zitten in afdrukken en pdf\'s die u hier maakt, maar nooit in deellinks of JSON-back-ups.',
        'photo.annotate': 'Annoteren',
        'photo.pen': 'Pen',
        'photo.arrow': 'Pijl',
        'photo.circle': 'Cirkel',
        'photo.undo': 'Laatste lijn ongedaan maken',
        'photo.annoSave': 'Annotatie opslaan',
        'photo.annoCancel': 'Annuleren',
        'photo.annoSaved': 'Annotatie in de foto opgeslagen.',
        'btn.visit': 'Kamer per kamer',
        'visit.title': 'Bezoek kamer per kamer',
        'visit.intro': 'Loop kamer per kamer door de woning. Kies de kamer waarin u staat, vink aan wat aanwezig is, en de bijhorende controles verschijnen.',
        'visit.room': 'In welke kamer staat u?',
        'visit.features': 'Wat is er in deze kamer?',
        'visit.hint': 'Alles wat u hier aanvinkt, noteert, fotografeert of annoteert komt in dezelfde keuring terecht als de hoofdchecklist - niets over te zetten.',
        'visit.empty': 'Kies hierboven een kamer om de controles te zien.',
        'visit.answered': '{done} van {total} punten beantwoord in deze selectie',
        'visit.another': 'Nog een toevoegen: {room}',
        'visit.instanceHint': 'Extra kamers zijn een loophulp op dit toestel: de hoofdchecklist houdt één gedeeld antwoord per punt bij - een probleem in eender welke kamer wint.',
        'visit.missing': 'U selecteerde {feature} niet. Is er geen {feature} in deze kamer?',
        'visit.missingConfirm': 'Klopt - geen {feature} hier',
        'visit.missingAdd': 'Er is wel {feature} - toon die controles',
        'visit.absenceNoted': 'Genoteerd: geen {feature} in {room}.',
        'visit.absenceLine': '{room}: geen {feature} aanwezig.',
        'visit.absenceUndo': 'Deze notitie verwijderen',
    ...
    fr: {
        ...
        'lookup.freeBadge': 'OSINT · gratuit',
        'lookup.loginBadge': 'eID / itsme',
        'lookup.open': 'Ouvrir',
        ...
        'lookup.group.living': 'Quartier & vie quotidienne',
        'lookup.group.prices': 'Prix & marché',
        'lookup.finding.ph': 'Constat noté, p.ex. score P C',
        'lookup.findingLabel': 'Votre constat (repris dans le rapport)',
        'menu.btn': 'Menu',
        'menu.visit': 'Pendant la visite',
        'menu.data': 'Vos données',
        'menu.info': 'Recherches & informations',
        'menu.display': 'Affichage',
        'prop.lookupLink': 'Recherches officielles pour cette adresse',
        'report.research': 'Recherche d\'adresse (recherches officielles)',
        'group.view': 'Affichage & langue',
        'rail.label': 'Actions rapides',
        'howto.title': 'Comment ça marche',
        'howto.step1': 'Saisissez l\'adresse une seule fois - la région, les délais légaux et les recherches officielles s\'adaptent automatiquement.',
        'howto.step2': 'Parcourez la maison avec la check-list : cochez OK ou Problème, ajoutez notes et photos par point.',
        'howto.step3': 'Transformez le résultat en rapport, PDF, lien de partage ou synthèse de négociation - tout reste sur votre appareil.',
        'howto.dismiss': 'Masquer cette explication',
        'photo.add': 'Ajouter une photo',
        'photo.title': 'Photos',
        'photo.view': 'Voir la photo',
        'photo.delete': 'Supprimer la photo',
        'photo.deleted': 'Photo supprimée.',
        'photo.error': 'Impossible d\'enregistrer la photo.',
        'photo.limit': 'Maximum 6 photos par point.',
        'photo.hint': 'Les photos restent sur cet appareil : elles figurent dans les impressions et PDF créés ici, mais jamais dans les liens de partage ni les sauvegardes JSON.',
        'photo.annotate': 'Annoter',
        'photo.pen': 'Stylo',
        'photo.arrow': 'Flèche',
        'photo.circle': 'Cercle',
        'photo.undo': 'Annuler le dernier trait',
        'photo.annoSave': 'Enregistrer l\'annotation',
        'photo.annoCancel': 'Annuler',
        'photo.annoSaved': 'Annotation enregistrée dans la photo.',
        'btn.visit': 'Pièce par pièce',
        'visit.title': 'Visite pièce par pièce',
        'visit.intro': 'Parcourez le bien une pièce à la fois. Choisissez la pièce où vous êtes, cochez ce qui est présent, et les contrôles correspondants apparaissent.',
        'visit.room': 'Dans quelle pièce êtes-vous ?',
        'visit.features': 'Qu\'y a-t-il dans cette pièce ?',
        'visit.hint': 'Tout ce que vous cochez, notez, photographiez ou annotez ici rejoint la même inspection que la check-list principale - rien à recopier.',
        'visit.empty': 'Choisissez une pièce ci-dessus pour voir ses contrôles.',
        'visit.answered': '{done} points sur {total} répondus dans cette sélection',
        'visit.another': 'En ajouter : {room}',
        'visit.instanceHint': 'Les pièces supplémentaires sont une aide de parcours sur cet appareil : la check-list principale garde une seule réponse par point - un problème constaté dans une pièce l\'emporte.',
        'visit.missing': 'Vous n\'avez pas sélectionné « {feature} ». Cette pièce n\'en a pas ?',
        'visit.missingConfirm': 'Exact - il n\'y en a pas',
        'visit.missingAdd': 'Il y en a - montrer ces contrôles',
        'visit.absenceNoted': 'Noté : {room} sans {feature}.',
        'visit.absenceLine': '{room} : sans {feature}.',
        'visit.absenceUndo': 'Supprimer cette note',
