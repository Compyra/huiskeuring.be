...
const LEGAL_META = {
    lastFullReview: '2026-08-25',
    reviewIntervalMonths: 6,
    nextReviewDue: '2027-02-25',
    ...
    epc: {
        ...
        regions: {
            ...
            wallonia: {
                ...
                deadline: {
                    en: 'PEB certificate valid up to 10 years, required before the property is even advertised',
                    nl: 'PEB-certificaat maximaal 10 jaar geldig, vereist nog vóór het pand geadverteerd wordt',
                    fr: 'Certificat PEB valable 10 ans maximum, requis avant même la mise en publicité du bien'
                },
                detail: {
                    en: 'The PEB certificate is drawn up by an approved certifier after a visit, is valid for a maximum of 10 years, and must exist before a home is put up for sale or rent - every advert must state the PEB indicators (energy class, primary energy consumption). It can be reused for a later sale or rental as long as it is still valid and the home has not changed. Wallonia has no purchase-triggered renovation obligation like Flanders; its long-term strategy aims at label A for the housing stock by 2050, but that does not impose a deadline on your individual purchase today.',
                    nl: 'Het PEB-certificaat wordt na een plaatsbezoek opgemaakt door een erkend certificeerder, is maximaal 10 jaar geldig en moet bestaan vóór een woning te koop of te huur wordt aangeboden - elke advertentie moet de PEB-indicatoren vermelden (energieklasse, primair energieverbruik). Het mag hergebruikt worden voor een latere verkoop of verhuur zolang het geldig is en de woning niet veranderd is. Wallonië kent geen renovatieverplichting gekoppeld aan de aankoop zoals Vlaanderen; de langetermijnstrategie mikt op label A voor het woningpark tegen 2050, maar dat legt vandaag geen termijn op aan uw individuele aankoop.',
                    fr: 'Le certificat PEB est établi par un certificateur agréé après une visite, est valable 10 ans maximum et doit exister avant la mise en vente ou en location - toute publicité doit mentionner les indicateurs PEB (classe énergétique, consommation d\'énergie primaire). Il peut resservir pour une vente ou location ultérieure tant qu\'il est valide et que le logement n\'a pas changé. La Wallonie ne connaît pas d\'obligation de rénovation liée à l\'achat comme en Flandre ; sa stratégie à long terme vise le label A pour le parc de logements en 2050, mais cela n\'impose aujourd\'hui aucun délai à votre achat individuel.'
                },
                sources: [
                    { label: 'Obtenir un certificat PEB (Wallonie)', url: 'https://www.wallonie.be/fr/demarches/vendreacheterlouer-obtenir-un-certificat-peb' },
                    { label: 'Certificat PEB : quoi, quand, comment (SPW Énergie)', url: 'https://energie.wallonie.be/home/performance-energetique-des-batiments/batiments-residentiels/achat-vente-location/obligations/certificat-peb--quoi--quand--comment.html' }
                ]
            },
            brussels: {
                status: 'verified',
    ...
    soil: {
        ...
        regions: {
            ...
            brussels: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Soil attestation required for every sale - the buyer must be informed at the compromis or offer stage',
                    nl: 'Bodemattest vereist bij elke verkoop - de koper moet al bij het compromis of het bod geïnformeerd zijn',
                    fr: 'Attestation du sol requise pour toute vente - l\'acheteur doit être informé au stade du compromis ou de l\'offre'
                },
                detail: {
                    en: 'A soil attestation from Bruxelles Environnement is legally required for every transfer of a parcel in the Brussels-Capital Region, built or not - for an apartment it covers the parcel under the building. The seller must inform the buyer of its content before the sale, at the compromis or offer stage. The attestation says whether the parcel is listed in the soil-state inventory and in which category, which determines whether studies or clean-up obligations exist. Ask for it early: obtaining one typically takes a few weeks, and it is a classic cause of delay just before signing.',
                    nl: 'Een bodemattest van Leefmilieu Brussel is wettelijk vereist bij elke overdracht van een perceel in het Brussels Hoofdstedelijk Gewest, bebouwd of niet - bij een appartement dekt het het perceel onder het gebouw. De verkoper moet de koper vóór de verkoop over de inhoud informeren, al bij het compromis of het bod. Het attest zegt of het perceel in de inventaris van de bodemtoestand staat en in welke categorie, wat bepaalt of er onderzoeks- of saneringsverplichtingen bestaan. Vraag het vroeg op: het bekomen duurt doorgaans enkele weken en het is een klassieke oorzaak van vertraging vlak voor de ondertekening.',
                    fr: 'Une attestation du sol de Bruxelles Environnement est légalement requise pour toute cession d\'une parcelle en Région de Bruxelles-Capitale, bâtie ou non - pour un appartement, elle porte sur la parcelle sous l\'immeuble. Le vendeur doit informer l\'acheteur de son contenu avant la vente, au stade du compromis ou de l\'offre. L\'attestation indique si la parcelle figure à l\'inventaire de l\'état du sol et dans quelle catégorie, ce qui détermine l\'existence d\'obligations d\'étude ou d\'assainissement. Demandez-la tôt : son obtention prend généralement quelques semaines et c\'est une cause classique de retard juste avant la signature.'
                },
                sources: [
                    { label: 'Attestation du sol (Bruxelles Environnement)', url: 'https://environnement.brussels/citoyen/reglementation-et-inspection/obligations-et-autorisations/attestation-du-sol-informations-et-obligations' },
                    { label: 'Inventaire de l\'état du sol', url: 'https://environnement.brussels/citoyen/agir-pour-lenvironnement/renover-et-construire/votre-sol-est-il-pollue-consultez-la-carte-de-linventaire-de-letat-du-sol' }
                ]
            }
        }
    },
    ...
    heating: {
        ...
        regions: {
            ...
            wallonia: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Oil and solid fuels: control every year. Gas up to 100 kW: every 3 years',
                    nl: 'Stookolie en vaste brandstoffen: jaarlijkse controle. Gas tot 100 kW: om de 3 jaar',
                    fr: 'Mazout et combustibles solides : contrôle annuel. Gaz jusqu\'à 100 kW : tous les 3 ans'
                },
                detail: {
                    en: 'In Wallonia the periodic control is what the law requires (a full service is advisable but distinct). Oil-fired and solid-fuel boilers must be controlled every year; domestic gas boilers up to 100 kW every 3 years (above 100 kW every 2 years). The clock starts at the boiler\'s first commissioning date, not at the date you buy the house, and the control must be done by a technician approved for that fuel, who issues a certificate to keep. Ask the seller for the most recent certificate - a missing one means an overdue control and possibly a neglected boiler.',
                    nl: 'In Wallonië is de periodieke controle de wettelijke verplichting (een volledig onderhoud is aan te raden maar staat daar los van). Stookolieketels en ketels op vaste brandstof moeten jaarlijks gecontroleerd worden; huishoudelijke gasketels tot 100 kW om de 3 jaar (boven 100 kW om de 2 jaar). De klok start bij de eerste ingebruikname van de ketel, niet bij uw aankoop van de woning, en de controle gebeurt door een voor die brandstof erkend technicus, die een attest aflevert. Vraag de verkoper het meest recente attest - ontbreekt het, dan is de controle vervallen en is de ketel mogelijk verwaarloosd.',
                    fr: 'En Wallonie, c\'est le contrôle périodique qui est imposé par la loi (un entretien complet est conseillé mais distinct). Les chaudières au mazout et aux combustibles solides doivent être contrôlées chaque année ; les chaudières gaz domestiques jusqu\'à 100 kW tous les 3 ans (au-delà de 100 kW, tous les 2 ans). Le point de départ est la première mise en service de la chaudière, pas la date d\'achat de la maison, et le contrôle est réalisé par un technicien agréé pour ce combustible, qui délivre une attestation. Demandez au vendeur l\'attestation la plus récente : son absence signifie un contrôle en retard et peut-être une chaudière négligée.'
                },
                sources: [
                    { label: 'Contrôle périodique des chaudières (SPW Énergie)', url: 'https://energie.wallonie.be/home/performance-energetique-des-batiments/batiments-residentiels/renovation-walloreno/conseils-pratiques/se-chauffer-1/controle-periodique-et-diagnostic-approfondi-des-chaudieres.html' },
            ...
            brussels: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Gas: PEB periodic control every 2 years. Oil and solid fuels: every year',
                    nl: 'Gas: periodieke EPB-controle om de 2 jaar. Stookolie en vaste brandstoffen: jaarlijks',
                    fr: 'Gaz : contrôle périodique PEB tous les 2 ans. Mazout et combustibles solides : tous les ans'
                },
                detail: {
                    en: 'Brussels imposes a "PEB periodic control" on boilers and water heaters: every 2 years for gas appliances, every year for oil-fired and solid-fuel boilers. Only technicians holding a Brussels Environment approval may perform it, and the certificate must be kept - it can be requested at an inspection or when the property changes hands. In practice the service and the control are done in one visit. Ask the seller for the latest certificate before you sign.',
                    nl: 'Brussel legt een "periodieke EPB-controle" op aan ketels en waterverwarmers: om de 2 jaar voor gastoestellen, jaarlijks voor stookolie- en vastebrandstofketels. Alleen technici met een erkenning van Leefmilieu Brussel mogen ze uitvoeren, en het attest moet bewaard worden - het kan opgevraagd worden bij een inspectie of bij de overdracht van het pand. In de praktijk gebeuren onderhoud en controle in één bezoek. Vraag de verkoper het laatste attest vóór u tekent.',
                    fr: 'Bruxelles impose un « contrôle périodique PEB » aux chaudières et chauffe-eau : tous les 2 ans pour les appareils au gaz, tous les ans pour les chaudières au mazout ou aux combustibles solides. Seuls les techniciens agréés par Bruxelles Environnement peuvent le réaliser, et l\'attestation doit être conservée - elle peut être exigée lors d\'une inspection ou d\'une mutation du bien. En pratique, l\'entretien et le contrôle se font en une seule visite. Demandez au vendeur la dernière attestation avant de signer.'
                },
                sources: [
                    { label: 'Entretien de la chaudière (Bruxelles Environnement)', url: 'https://environnement.brussels/entretien-chaudiere' }
                ]
            }
        }
    },
    ...
    smokedetector: {
        ...
        regions: {
            ...
            wallonia: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Every dwelling must have at least one working fire detector - in force since 2004',
                    nl: 'Elke woning moet minstens één werkende branddetector hebben - van kracht sinds 2004',
                    fr: 'Tout logement doit compter au moins un détecteur d\'incendie en état de marche - en vigueur depuis 2004'
                },
                detail: {
                    en: 'Article 4bis of the Walloon Housing Code (Code wallon de l\'habitation durable) requires every individual or collective dwelling to be equipped with at least one fire detector in perfect working order; the rule has been in force since 2004. Detectors must be optical smoke detectors conforming to NBN EN 14604, BOSEC-approved or a European equivalent (VdS, BS...), with a 5-year guarantee. The owner buys and installs them; a tenant maintains them, changes the batteries and reports a failing detector to the owner. The number depends on the size and layout of the dwelling - the SPW Logement brochure sets out the count and placement per case.',
                    nl: 'Artikel 4bis van de Waalse Wooncode (Code wallon de l\'habitation durable) verplicht elke individuele of collectieve woning uit te rusten met minstens één branddetector in perfecte staat van werking; de regel geldt sinds 2004. De melders moeten optische rookmelders zijn conform NBN EN 14604, BOSEC-gekeurd of een Europees equivalent (VdS, BS...), met 5 jaar garantie. De eigenaar koopt en plaatst ze; een huurder onderhoudt ze, vervangt de batterijen en meldt een defecte melder aan de eigenaar. Het aantal hangt af van de grootte en indeling van de woning - de brochure van SPW Logement legt aantal en plaatsing per geval vast.',
                    fr: 'L\'article 4bis du Code wallon de l\'habitation durable impose que tout logement individuel ou collectif soit équipé d\'au moins un détecteur d\'incendie en parfait état de fonctionnement ; la règle est en vigueur depuis 2004. Les détecteurs doivent être des détecteurs optiques de fumée conformes à la norme NBN EN 14604, agréés BOSEC ou équivalent européen (VdS, BS...), garantis 5 ans. Le propriétaire les achète et les installe ; le locataire les entretient, change les piles et signale tout détecteur défaillant au propriétaire. Le nombre dépend de la taille et de la configuration du logement - la brochure du SPW Logement détaille le nombre et l\'emplacement par cas.'
                },
                sources: [
                    { label: 'Disposer de détecteurs incendie (Wallonie)', url: 'https://www.wallonie.be/fr/demarches/disposer-de-detecteurs-incendie-dans-votre-logement' },
                    { label: 'Les détecteurs incendie en Wallonie', url: 'https://www.wallonie.be/fr/les-detecteurs-incendie-en-wallonie' }
                ]
            },
            brussels: {
                status: 'verified',
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Since 1 January 2025 compulsory in ALL dwellings - at least one detector per floor',
                    nl: 'Sinds 1 januari 2025 verplicht in ALLE woningen - minstens één melder per verdieping',
                    fr: 'Depuis le 1er janvier 2025, obligatoires dans TOUS les logements - au moins un détecteur par étage'
                },
                detail: {
                    en: 'Smoke detectors used to be compulsory only in rented dwellings in Brussels. Since 1 January 2025 they are required in ALL dwellings of the Brussels-Capital Region, owner-occupied included. Count at least one detector per floor; under the implementing decree of 28 September 2023, a dwelling that needs four or more detectors must use interconnected detectors or a centralised detection system. When viewing a property, check they are actually present and within their service life - the replacement date is printed on the housing.',
                    nl: 'Rookmelders waren in Brussel enkel verplicht in huurwoningen. Sinds 1 januari 2025 zijn ze vereist in ALLE woningen van het Brussels Hoofdstedelijk Gewest, ook die van eigenaar-bewoners. Reken op minstens één melder per verdieping; volgens het uitvoeringsbesluit van 28 september 2023 moet een woning die vier of meer melders nodig heeft, gekoppelde melders of een centraal detectiesysteem gebruiken. Controleer bij het bezoek of ze er effectief hangen en nog binnen hun levensduur zijn - de vervangdatum staat op de behuizing.',
                    fr: 'Les détecteurs de fumée n\'étaient obligatoires à Bruxelles que dans les logements loués. Depuis le 1er janvier 2025, ils sont exigés dans TOUS les logements de la Région de Bruxelles-Capitale, y compris ceux occupés par leur propriétaire. Comptez au moins un détecteur par étage ; selon l\'arrêté d\'exécution du 28 septembre 2023, un logement nécessitant quatre détecteurs ou plus doit être équipé de détecteurs interconnectés ou d\'un système de détection centralisé. Lors de la visite, vérifiez qu\'ils sont bien présents et encore dans leur durée de vie - la date de remplacement figure sur le boîtier.'
                },
                sources: [
                    { label: 'Détecteurs de fumée (be.brussels)', url: 'https://be.brussels/fr/logement/construction-et-renovation/securite-et-reglementation/detecteurs-de-fumee' },
    ...
    oiltank: {
        ...
        regions: {
            flanders: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Under 6,000 l: buried tanks every 5 years, above-ground tanks no periodic check since 1 March 2009',
                    nl: 'Onder 6.000 l: ingegraven tanks om de 5 jaar, bovengrondse tanks geen periodieke keuring meer sinds 1 maart 2009',
                    fr: 'Moins de 6 000 l : citernes enterrées tous les 5 ans, citernes aériennes plus de contrôle périodique depuis le 1er mars 2009'
                },
                detail: {
                    en: 'Every heating-oil tank must be checked at placement, before first use. For household tanks under 5,000 kg (6,000 litres): a buried tank must be re-inspected every 5 years; an above-ground tank - and a tank in a cellar counts as above-ground - no longer needs periodic inspection since 1 March 2009, only the placement check. Tanks of 6,000 litres or more follow stricter cycles (buried: limited check every 2 years and a thorough one every 15 years; above-ground: every 3 years), tightened further in water-catchment areas. After each check the tank gets a green (compliant), orange (fix within 6 months, refilling still allowed) or red marker (refilling forbidden, reported to the authority within 14 days). There is no legal obligation to hand the buyer a tank certificate at a sale, but Flanders itself notes it is part of the seller\'s duty to deliver - so ask for the certificate and the marker colour anyway.',
                    nl: 'Elke stookolietank moet bij plaatsing en vóór ingebruikname gecontroleerd worden. Voor woningtanks onder 5.000 kg (6.000 liter): een ingegraven tank moet om de 5 jaar herkeurd worden; een bovengrondse tank - en een tank in de kelder telt als bovengronds - moet sinds 1 maart 2009 niet meer periodiek gekeurd worden, alleen de plaatsingscontrole. Tanks van 6.000 liter of meer volgen strengere cycli (ingegraven: beperkt onderzoek om de 2 jaar en grondig onderzoek om de 15 jaar; bovengronds: om de 3 jaar), nog strenger in waterwingebieden. Na elke controle krijgt de tank een groene (conform), oranje (herstellen binnen 6 maanden, vullen mag nog) of rode merkplaat (vullen verboden, binnen 14 dagen gemeld aan de toezichthouder). Er is geen wettelijke plicht om de koper bij verkoop een keuringsattest te bezorgen, maar Vlaanderen merkt zelf op dat het deel uitmaakt van de leveringsplicht van de verkoper - vraag dus toch het attest en de kleur van de merkplaat.',
                    fr: 'Toute citerne à mazout doit être contrôlée au placement, avant la première utilisation. Pour les citernes domestiques de moins de 5 000 kg (6 000 litres) : une citerne enterrée doit être recontrôlée tous les 5 ans ; une citerne aérienne - une citerne en cave compte comme aérienne - ne nécessite plus de contrôle périodique depuis le 1er mars 2009, seulement le contrôle de placement. Les citernes de 6 000 litres ou plus suivent des cycles plus stricts (enterrées : examen limité tous les 2 ans et examen approfondi tous les 15 ans ; aériennes : tous les 3 ans), renforcés en zone de captage. Après chaque contrôle, la citerne reçoit une plaquette verte (conforme), orange (réparer sous 6 mois, remplissage encore autorisé) ou rouge (remplissage interdit, signalement à l\'autorité sous 14 jours). Il n\'existe pas d\'obligation légale de remettre à l\'acheteur une attestation de contrôle lors d\'une vente, mais la Flandre précise elle-même que cela relève du devoir de délivrance du vendeur - demandez donc l\'attestation et la couleur de la plaquette.'
                },
                sources: [
                    { label: 'Controle en onderhoud stookolietank (Vlaanderen)', url: 'https://www.vlaanderen.be/controle-en-onderhoud-van-de-stookolietank-van-een-woning' }
                ]
            },
            wallonia: {
                status: 'verified',
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'From 3,000 l the tank is a class 3 installation: declaration plus periodic control by an approved technician',
                    nl: 'Vanaf 3.000 l is de tank een inrichting van klasse 3: aangifte plus periodieke controle door een erkend technicus',
                    fr: 'À partir de 3 000 l, la citerne est un établissement de classe 3 : déclaration et contrôle périodique par un technicien agréé'
                },
                detail: {
                    en: 'In Wallonia a heating-oil store of 3,000 litres or more - even spread over several tanks - is a class 3 installation: it must be declared under the environmental-permit system and must respect the conditions of the decree of 17 July 2003, including periodic control by an approved technician. Below 3,000 litres no declaration is required, but controls and maintenance remain strongly advised. A tank that is taken out of use - for example after switching to gas - must be definitively decommissioned: emptied, cleaned and neutralised, with the paperwork to prove it. Ask for that certificate whenever a disused tank is still on the property.',
                    nl: 'In Wallonië is een stookolieopslag van 3.000 liter of meer - ook verspreid over meerdere tanks - een inrichting van klasse 3: ze moet aangegeven worden in het stelsel van de milieuvergunning en moet voldoen aan de voorwaarden van het besluit van 17 juli 2003, waaronder een periodieke controle door een erkend technicus. Onder 3.000 liter is geen aangifte vereist, maar controles en onderhoud blijven sterk aangeraden. Een tank die buiten gebruik gaat - bijvoorbeeld na de overstap op gas - moet definitief buiten dienst gesteld worden: geledigd, gereinigd en geneutraliseerd, met de papieren als bewijs. Vraag dat attest telkens er nog een ongebruikte tank op het terrein staat.',
                    fr: 'En Wallonie, un dépôt de mazout de 3 000 litres ou plus - même réparti sur plusieurs réservoirs - est un établissement de classe 3 : il doit être déclaré dans le cadre du permis d\'environnement et respecter les conditions de l\'arrêté du 17 juillet 2003, dont le contrôle périodique par un technicien agréé. Sous 3 000 litres, aucune déclaration n\'est requise, mais contrôles et entretien restent fortement conseillés. Une citerne mise hors service - par exemple après un passage au gaz - doit être définitivement désaffectée : vidée, nettoyée et neutralisée, documents à l\'appui. Exigez cette attestation dès qu\'une citerne désaffectée se trouve encore sur la propriété.'
                },
                sources: [
                    { label: 'Gérer sa citerne à mazout (Wallonie)', url: 'https://www.wallonie.be/fr/demarches/gerer-sa-citerne-mazout' },
            ...
            brussels: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Above-ground under 3,000 l: no declaration needed. Larger or buried tanks: classified installation',
                    nl: 'Bovengronds onder 3.000 l: geen aangifte nodig. Grotere of ingegraven tanks: ingedeelde inrichting',
                    fr: 'Aérienne de moins de 3 000 l : aucune déclaration. Citernes plus grandes ou enterrées : installation classée'
                },
                detail: {
                    en: 'In Brussels an above-ground heating-oil tank of less than 3,000 litres is not a classified installation: no declaration and no environmental permit are required. Larger tanks and buried tanks are classified installations that need a declaration or an environmental permit, filed with the commune - depending on the case the commune or Bruxelles Environnement handles the file - and carry maintenance and control conditions. When buying, ask which regime the tank falls under, whether the declaration or permit exists, and - for a tank that is no longer used - for proof that it was emptied, cleaned and neutralised.',
                    nl: 'In Brussel is een bovengrondse stookolietank van minder dan 3.000 liter geen ingedeelde inrichting: er is geen aangifte en geen milieuvergunning nodig. Grotere tanks en ingegraven tanks zijn ingedeelde inrichtingen die een aangifte of milieuvergunning vereisen, ingediend bij de gemeente - naargelang het geval behandelt de gemeente of Leefmilieu Brussel het dossier - en waaraan onderhouds- en controlevoorwaarden verbonden zijn. Vraag bij aankoop onder welk regime de tank valt, of de aangifte of vergunning bestaat, en - voor een tank die niet meer gebruikt wordt - het bewijs dat hij geledigd, gereinigd en geneutraliseerd werd.',
                    fr: 'A Bruxelles, une citerne à mazout aérienne de moins de 3 000 litres n\'est pas une installation classée : aucune déclaration ni permis d\'environnement n\'est requis. Les citernes plus grandes et les citernes enterrées sont des installations classées soumises à déclaration ou à permis d\'environnement, déposé à la commune - selon le cas, la commune ou Bruxelles Environnement traite le dossier - avec des conditions d\'entretien et de contrôle. À l\'achat, demandez sous quel régime tombe la citerne, si la déclaration ou le permis existe et, pour une citerne désaffectée, la preuve qu\'elle a été vidée, nettoyée et neutralisée.'
                },
                sources: [
                    { label: 'Citerne à mazout : vos obligations (Bruxelles Environnement)', url: 'https://environnement.brussels/citoyen/reglementation-et-inspection/obligations-et-autorisations/citerne-mazout-quelles-sont-vos-obligations' }
                ]
            }
        }
    },
    ...
    registration: {
        ...
        regions: {
            ...
            wallonia: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: '3% for the sole and own home (since 1 January 2025), 12.5% otherwise',
                    nl: '3% voor de enige eigen woning (sinds 1 januari 2025), 12,5% in de andere gevallen',
                    fr: '3 % pour l\'habitation propre et unique (depuis le 1er janvier 2025), 12,5 % sinon'
                },
                detail: {
                    en: 'Since 1 January 2025 Wallonia applies a reduced rate of 3% for the purchase of the sole and own home - down from the ordinary rate of 12.5% - and the reform also covers building land and a home under construction or bought on plan destined to become that sole own home. There is no cadastral-income condition. The ordinary rate of 12.5% remains for every other purchase. Conditions apply, including actually making it your own home; the official FAQ of the Walloon tax reform details them, and your notary applies the rate at the deed.',
                    nl: 'Sinds 1 januari 2025 hanteert Wallonië een verlaagd tarief van 3% voor de aankoop van de enige eigen woning - tegenover het gewone tarief van 12,5% - en de hervorming geldt ook voor bouwgrond en een woning in aanbouw of op plan die die enige eigen woning moet worden. Er is geen voorwaarde rond het kadastraal inkomen. Het gewone tarief van 12,5% blijft gelden voor elke andere aankoop. Er gelden voorwaarden, waaronder er effectief uw eigen woning van maken; de officiële FAQ van de Waalse fiscale hervorming somt ze op, en uw notaris past het tarief toe bij de akte.',
                    fr: 'Depuis le 1er janvier 2025, la Wallonie applique un taux réduit de 3 % pour l\'acquisition de l\'habitation propre et unique - contre le taux ordinaire de 12,5 % - et la réforme couvre aussi le terrain à bâtir et l\'habitation en construction ou sur plan destinée à devenir cette habitation propre et unique. Il n\'y a pas de condition de revenu cadastral. Le taux ordinaire de 12,5 % subsiste pour toute autre acquisition. Des conditions s\'appliquent, dont celle d\'en faire effectivement votre propre habitation ; la FAQ officielle de la réforme fiscale wallonne les détaille, et votre notaire applique le taux à l\'acte.'
                },
                sources: [
                    { label: 'Réduction des droits d\'enregistrement (Wallonie)', url: 'https://www.wallonie.be/fr/actualites/reduction-des-droits-denregistrement-de-succession-et-de-donation' },
    ...
    water: {
        ...
        regions: {
            ...
            wallonia: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'CertIBEau compulsory since 1 June 2021 for every first connection to the water network',
                    nl: 'CertIBEau verplicht sinds 1 juni 2021 bij elke eerste aansluiting op het waternet',
                    fr: 'CertIBEau obligatoire depuis le 1er juin 2021 pour tout premier raccordement à la distribution d\'eau'
                },
                detail: {
                    en: 'Wallonia has its own water certificate: the CertIBEau (Certificat des Immeubles Bâtis pour l\'Eau). Since 1 June 2021 it is compulsory for every building connected to the water distribution network for the first time - so for new builds - and it covers both the indoor drinking-water installation and the waste-water side (correct separation and discharge). An approved certifier visits and issues the certificate; without a compliant CertIBEau the new connection cannot be put into normal service. For existing homes it is not required at a sale, but an available CertIBEau is a genuine quality signal. Sanitation itself is governed by the règlement général d\'assainissement: the address is classified as collective, autonomous or transitory sanitation, which decides whether you connect to a sewer or must install an individual treatment unit. Rainwater tanks and infiltration are imposed through the permit and municipal rules - do not assume the Flemish figures apply.',
                    nl: 'Wallonië heeft een eigen watercertificaat: het CertIBEau (Certificat des Immeubles Bâtis pour l\'Eau). Sinds 1 juni 2021 is het verplicht voor elk gebouw dat voor het eerst op het waterdistributienet wordt aangesloten - dus bij nieuwbouw - en het dekt zowel de drinkwaterinstallatie binnen als de afvalwaterzijde (correcte scheiding en lozing). Een erkend certificeerder komt ter plaatse en levert het certificaat af; zonder conform CertIBEau kan de nieuwe aansluiting niet normaal in dienst gaan. Voor bestaande woningen is het niet vereist bij verkoop, maar een beschikbaar CertIBEau is een echt kwaliteitssignaal. De sanering zelf valt onder het règlement général d\'assainissement: het adres wordt ingedeeld als collectieve, autonome of overgangssanering, wat bepaalt of u aansluit op de riolering dan wel een individuele zuivering moet plaatsen. Hemelwaterputten en infiltratie worden opgelegd via de vergunning en gemeentelijke regels - ga er niet van uit dat de Vlaamse cijfers gelden.',
                    fr: 'La Wallonie possède son propre certificat de l\'eau : le CertIBEau (Certificat des Immeubles Bâtis pour l\'Eau). Depuis le 1er juin 2021, il est obligatoire pour tout immeuble raccordé pour la première fois à la distribution d\'eau - donc pour les constructions neuves - et il couvre à la fois l\'installation intérieure d\'eau potable et le volet eaux usées (séparation et évacuation correctes). Un certificateur agréé se rend sur place et délivre le certificat ; sans CertIBEau conforme, le nouveau raccordement ne peut pas être mis en service normalement. Pour un logement existant, il n\'est pas requis à la vente, mais un CertIBEau disponible est un vrai signal de qualité. L\'assainissement relève du règlement général d\'assainissement : l\'adresse est classée en assainissement collectif, autonome ou transitoire, ce qui détermine si vous vous raccordez à l\'égout ou devez installer une unité d\'épuration individuelle. Les citernes d\'eau de pluie et l\'infiltration sont imposées via le permis et les règles communales - ne supposez pas que les chiffres flamands s\'appliquent.'
                },
                sources: [
                    { label: 'CertIBEau (Wallonie)', url: 'https://www.wallonie.be/fr/demarches/sinformer-sur-le-certificat-des-immeubles-batis-pour-leau-certibeau' },
    ...
    permit: {
        ...
        regions: {
            ...
            brussels: {
                ...
                lastVerified: '2026-08-25',
                deadline: {
                    en: 'Urbanistic information (art. 275 CoBAT) is compulsory for every sale - usually requested by the notary',
                    nl: 'Stedenbouwkundige inlichtingen (art. 275 BWRO) zijn verplicht bij elke verkoop - meestal opgevraagd door de notaris',
                    fr: 'Les renseignements urbanistiques (art. 275 du CoBAT) sont obligatoires pour toute vente - généralement demandés par le notaire'
                },
                detail: {
                    en: 'In Brussels the "renseignements urbanistiques" are compulsory for every sale or transfer of real rights, under article 275 of the Brussels planning code (CoBAT). They are requested from the commune - in practice usually by the notary - and state the most recent lawful planning destination of the property and the regional and municipal rules that apply to it. Read them against what is actually built: a bedroom in an attic, a garden office or a subdivided house that does not appear in them points to unpermitted works, and the buyer inherits that problem. Building permits themselves are handled by the commune and by urban.brussels.',
                    nl: 'In Brussel zijn de "stedenbouwkundige inlichtingen" verplicht bij elke verkoop of overdracht van zakelijke rechten, op grond van artikel 275 van het Brussels Wetboek van Ruimtelijke Ordening (BWRO/CoBAT). Ze worden opgevraagd bij de gemeente - in de praktijk meestal door de notaris - en vermelden de meest recente wettige stedenbouwkundige bestemming van het pand en de gewestelijke en gemeentelijke regels die erop van toepassing zijn. Lees ze naast wat er effectief gebouwd is: een slaapkamer op zolder, een tuinkantoor of een opgedeelde woning die er niet in voorkomt, wijst op niet-vergunde werken - en de koper erft dat probleem. Bouwvergunningen zelf worden behandeld door de gemeente en urban.brussels.',
                    fr: 'À Bruxelles, les renseignements urbanistiques sont obligatoires pour toute vente ou cession de droits réels, en vertu de l\'article 275 du Code bruxellois de l\'aménagement du territoire (CoBAT). Ils se demandent à la commune - en pratique généralement par le notaire - et indiquent la destination urbanistique licite la plus récente du bien ainsi que les dispositions régionales et communales qui s\'y appliquent. Confrontez-les à ce qui est réellement bâti : une chambre sous les combles, un bureau de jardin ou une maison divisée qui n\'y figure pas révèle des travaux non autorisés - et l\'acheteur hérite du problème. Les permis d\'urbanisme eux-mêmes sont traités par la commune et par urban.brussels.'
                },
                sources: [
                    { label: 'Renseignements urbanistiques - cadre légal (urba.irisnet.be)', url: 'https://urba.irisnet.be/fr/renseignementsurbanistiques/cadre-legal' },
                    { label: 'Renseignements urbanistiques (Ville de Bruxelles)', url: 'https://www.bruxelles.be/renseignements-urbanistiques' },
                    { label: 'Homegrade', url: 'https://homegrade.brussels/' }
                ]
            }
        }
