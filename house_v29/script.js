...
function checkFirstVisit() {
    const hasVisitedBefore = localStorage.getItem('hasVisitedHouseInspection');
    
    if (!hasVisitedBefore) {
        // First time visitor - show help modal
        helpModal.classList.add('show');
        // Mark that they've visited
        localStorage.setItem('hasVisitedHouseInspection', 'true');
    }
}
...
item-note-textarea                    <div class="item-text-wrapper">
