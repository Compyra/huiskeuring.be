    ...
    registration: {
        ...
        regions: {
            flanders: {
                ...
                lastVerified: '2026-07-28',
                deadline: {
                    en: '2% for the sole and own home (since 1 January 2025), 12% otherwise',
                    nl: '2% voor de enige eigen woning (sinds 1 januari 2025), 12% in de andere gevallen',
                    fr: '2 % pour l\'habitation propre et unique (depuis le 1er janvier 2025), 12 % sinon'
                },
                detail: {
                    en: 'The rate for the sole and own home was lowered from 3% to 2% on 1 January 2025. The general rate is 12% and has applied since 1 January 2022 to agreements signed from that date. Unbuilt agricultural land and nature reserves keep a 10% rate. Conditions apply to the "sole and own home" rate, including actually living there.',
                    nl: 'Het tarief voor de enige eigen woning daalde op 1 januari 2025 van 3% naar 2%. Het algemene tarief bedraagt 12% en geldt sinds 1 januari 2022 voor overeenkomsten vanaf die datum. Onbebouwde landbouwgronden en natuurgebieden behouden 10%. Er gelden voorwaarden voor het tarief "enige eigen woning", waaronder er ook effectief gaan wonen.',
                    fr: 'Le taux pour l\'habitation propre et unique est passé de 3 % à 2 % le 1er janvier 2025. Le taux général est de 12 % et s\'applique depuis le 1er janvier 2022 aux conventions signées à partir de cette date. Les terres agricoles non bâties et les réserves naturelles conservent 10 %. Des conditions s\'appliquent au taux « habitation propre et unique », dont celle d\'y habiter effectivement.'
                },
                sources: [
