...
function updateIssueFilters() {
    console.log('updateIssueFilters() called');
    const issueFilterContainer = document.getElementById('issueFilterButtons');
    if (!issueFilterContainer) {
        console.warn('Issue filter container not found!');
        return;
    }
    
    console.log('Current state.renovationNeeded:', state.renovationNeeded);
    ...
    checklistData.forEach((category, categoryIndex) => {
        console.log('Checking category:', category.category, 'index:', categoryIndex);
        
        // Skip categories that shouldn't be shown for current property type
        if (!shouldShowCategory(category, 'all')) {
            console.log('  Skipping category (shouldShowCategory returned false)');
            return;
        }
        ...
        category.items.forEach((item, itemIndex) => {
            ...
            if (state.renovationNeeded[itemKey]) {
                console.log('  Found checked issue:', itemKey, 'tags:', item.tags);
...
function handleRenovationChange(e) {
    ...
    console.log('Issue checkbox changed:', key, 'checked:', e.target.checked);
    console.log('Current renovationNeeded state:', state.renovationNeeded);
